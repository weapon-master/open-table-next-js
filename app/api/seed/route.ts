...
export async function GET(
  ...
  const indianCuisineId =
    cuisines.find((cusine) => cusine.name === "indian")?.id || 1;
  const mexicanCuisineId =
    cuisines.find((cusine) => cusine.name === "mexican")?.id || 1;
  const italianCuisineId =
    cuisines.find((cusine) => cusine.name === "italian")?.id || 1;
